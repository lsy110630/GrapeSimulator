...
public class OverallsPodo : MonoBehaviour
{
    GameObject director;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if ((one == true) && (collision.gameObject.tag == "Circle"))
        {
            ...
            if (dice <= this.director.GetComponent<MainGameDirector>().bP)
            {
                ...
                this.director.GetComponent<MainGameDirector>().overallspodo = 1;
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        {
            // 포도 애니메이션 작동
            this.GetComponent<Animator>().Play("OverallsAnimation");
            ...
            if (this.delta > span)
            {
                ...
                this.director.GetComponent<MainGameDirector>().overallspodo = 1;    // 아티팩트를 먹은걸 표시
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        ...
        {
            // 포도 에니메이션 종료
            this.GetComponent<Animator>().Play("OverallsIdle");
        }
    }
}
